...
def run(args):
    ...
    newfasta= open(f"{PathToFasta}_renamed", "w")
...
def main():
    parser = argparse.ArgumentParser(description='Use this to rename all sequnces in a fasta file with its common name, with reference to a GB file')
